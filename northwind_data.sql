...
----------------------------------------------------------------------------------------------------------------------------------------
------- The above data was provided for data manipulation excercise. The examples below are different application of MYSQL syntax to draw 
-------- out insights from the above data.
----------------------------------------------------------------------------------------------------------------------------------------
...
------------select and sort customers table and arranged alphabetically by city names------------

select * from customers 
order by city ASC;

------------select and sort customers table and arranged in descending order by city names------------

select * from customers
order by city DESC;

-------------select and sort records in customer table, arranged alphabetically by country and city--------

select * from customers 
order by country_region, city ASC;

---------------Select all records from the Customers where the PostalCode column is empty-------

select * from customers
where zip_postal_code is null;

--------------------Select all records from the Customers where the PostalCode column is not empty------

select * from customers
where zip_postal_code is not null;

-------------------------Update the City column of all records in the Customers table to Lagos-----

update customers
set city = Lagos
where id < 30;

---------------------Delete all the records from the Invoice table where the ID values are 5, 12 and 36------
...
----------------Use the MIN function to select the record with the smallest value of the standard_cost column in the Product table--------

select min(standard_cost)
from products;

-------------------Use an SQL function to select the record with the highest value of the standard_cost column in the Product table-------

select max(standard_cost)
from products;

-----------------Use an SQL function to calculate the average list_price of all products in the Product table-------------

select avg(list_price)
from products;

--------------Use an SQL function to calculate the sum of all the list_price column values in the Products table-------

select sum(productslist_price)
from products;

----------------Use the correct function to return the numbers of records that have the target_level value set to 40 in the Product table......

select count(target_level)
from products
